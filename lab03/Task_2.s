...
.text
.globl main           # Main entry point should be _start

main:
    # Initialize and call dataArray with example value (e.g., num = 5)
...
compare:
    ...
    # Check if result >= 0 (more efficient version)
...
dataArray:
    addi sp, sp, -52    # Allocate space:
                        ...
                        # 4 bytes padding to keep 16-byte alignment
